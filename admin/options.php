<div id="content-area">
	...
	<form name="update-options" id="update=options" action="<?php Options::out('base_url'); ?>admin/post/update-options">
		<p><label>Base URL:</label></p>
		<p><input type="text" value="<?php Options::out('base_url'); ?>"/></p>
		<p><label>Blog Title:</label></p>
		<p><input type="text" value="<?php Options::out('blog_title'); ?>"/></p>
		<p><label>Blog Tag Line:</label></p>
		<p><input type="text" value="<?php Options::out('blog_tagline'); ?>"/></p>
		<p><label>About Text:</label></p>
		<p><textarea><?php Options::out('about'); ?></textarea></p>
