...
<div class="modulecore">
	...
	<ul class="items">
		...
		<li class="item clear">
			...
			<span class="title pct75"><a href="<?php echo $post->permalink; ?>"><?php echo $post->title; ?></a> <a class="minor" href="<?php Site::out_url('habari'); ?>/admin/user/<?php echo $post->author->username; ?>">by <?php echo $post->author->displayname; ?></a></span>
