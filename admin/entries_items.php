...
<div class="item clear" id="post_<?php echo $post->id; ?>">
	<div class="head clear">
		...
		<span class="author pct20"><a href="<?php URL::out('admin', array('page' => 'entries', 'user_id' => $post->user_id, 'type' => $post->content_type, 'status' => 'any') ); ?>"><span class="dim"><?php _e('by'); ?></span> <?php echo $post->author->displayname ? $post->author->displayname : $post->author->username; ?></a></span>
