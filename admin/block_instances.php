...
<div id="block_instances">
	...
	<div class="block_instance">
		<h3><?php echo htmlspecialchars($instance->title, ENT_COMPAT, 'UTF-8'); ?></h3>
		<ul>
			<li><a href="#" onclick="var i = $('<iframe src=\'<?php echo URL::get('admin', array('page' => 'configure_block', 'blockid' => $instance->id)); ?>\' style=\'width:600px;height:300px;\'></iframe>'); i.dialog({bgiframe:true,height:300,width:778,modal:true,dialogClass:'jqueryui',draggable:false,title:'Configure Block: <?php echo htmlspecialchars($instance->title, ENT_COMPAT, 'UTF-8'); ?>'});i.css('width','768px');return false;">configure</a></li>
