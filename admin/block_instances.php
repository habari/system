...
<div id="block_instances">
	...
	<div class="block_instance">
		...
		<?php if ( $instance->get_form()->controls ) { ?>
			<li><a href="#" onclick="var i = $('<iframe src=\'<?php echo URL::get('admin', array('page' => 'configure_block', 'blockid' => $instance->id)); ?>\' style=\'width:600px;height:300px;\'></iframe>'); i.dialog({bgiframe:true,width:778,modal:true,dialogClass:'jqueryui',title:'<?php _e('Configure Block: %1s (%2s)', array(Utils::htmlspecialchars($instance->title), Utils::htmlspecialchars($instance->type))); ?>'});i.css('width','768px');return false;"><?php _e( 'Configure'); ?></a></li>
		<?php } ?>
