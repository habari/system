		...
		<h4>Published Entries</h4>
			<table id="post-data-published" width="100%" cellspacing="0">
				...
				<tr>
					...
					<td><a href="<?php Options::out('host_url'); ?><?php echo $post->username; ?>"><?php echo $post->username; ?></a></td>
					<td><?php echo $post->pubdate; ?></td>
					<td align="center">
						<a href="<?php Options::out('base_url'); ?><?php echo $post->post_slug; ?>" title="View this Entry">
							<img src="<?php Options::out('host_url'); ?>system/admin/images/view.png" alt="View this entry" />
						</a>
						<a href="<?php URL::out('admin', 'page=publish&slug=' . $post->slug); ?>" title="Edit this entry">
							<img src="<?php Options::out('host_url'); ?>system/admin/images/edit.png" alt="Edit this entry" />
						</a>
		...
		<h4>Entries Currently in Draft</h4>
			<table id="post-data-draft" width="100%" cellspacing="0">
				...
				<tr>
					...
					<td><a href="<?php Options::out('host_url'); ?><?php echo $post->username; ?>"><?php echo $draft->username; ?></a></td>
