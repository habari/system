			...
			<div class="themeoptions columns ten">
				...
				<div id="blocksconfigure" class="item container">
					...
					<div class="columns four">
						...
						<div class="formcontrol"><button id="save_areas" disabled="disabled"><?php _e('Save'); ?></button></div>
					</div>
				<?php endif; ?>
			</div>
		</div>
...
<div class="container main availablethemes">
	...
	<?php foreach ( $all_themes as $inactive_theme ):
		...
		<div class="item <?php if ($previewed == $inactive_theme['dir']) echo " previewing"; ?>"> 
		    ...
		    <?php if ( $inactive_theme['info']->getName() != 'pluggable' || (string) $inactive_theme['info']->attributes()->type != 'theme' ) : ?>
			...
			<div class="clearfix sixteen">
		    <div class="thumb columns">
				<img class="themethumb" src="<?php echo $inactive_theme['screenshot']; ?>">
			</div>
