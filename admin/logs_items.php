...
<?php foreach ( $logs as $log ): ?>
	<div class="item clear">
		<span class="checkbox pct5"><span><input type="checkbox" class="checkbox log_entry" name="checkbox_ids[<?php echo $log->id; ?>]" id="checkbox_ids[<?php echo $log->id; ?>]"></span></span>
