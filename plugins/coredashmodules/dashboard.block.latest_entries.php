...
?>
	<ul class="items">
		...
		<li class="item">
			...
			<span class="title"><a href="<?php URL::out('display_publish', $post, false); ?>" title="<?php printf( _t('Edit \'%s\''), $post->title ); ?>"><?php echo $post->title; ?></a> <span><?php _e('by'); ?></span> <a href="<?php Site::out_url('admin'); ?>/user/<?php echo $post->author->username; ?>"><?php echo $post->author->displayname; ?></a></span>
