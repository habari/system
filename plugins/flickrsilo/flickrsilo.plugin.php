...
class flickrAPI
{
	function __construct() {
		$this->key= '13aad53fe0202b4245e0e962927d093f';
		$this->secret= '4c9d5f7b233586dd';
    ...
    public function action_plugin_ui($plugin_id, $action)
    {
		if ($plugin_id == $this->plugin_id()) {
			switch ($action) {
				case 'Authenticate' :
					$flickr= new Flickr();
					echo '<a href="' . $flickr->authLink() . '" title="Auth Habari" target="_blank">Clicky</a>';
				break;
			} 
		} 
	}
