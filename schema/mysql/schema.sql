...
INSERT INTO {$prefix}rewrite_rules (name, parse_regex, build_str, handler, action, priority, is_active, rule_class, description) VALUES ('index_page', '/^(?:|page\\/(?P<page>\\d+)[\\/]?)$/', '(page/{$page})', 'UserThemeHandler', 'display_home', '1000', '1', '1', 'Homepage (index) display');INSERT INTO {$prefix}rewrite_rules (name, parse_regex, build_str, handler, action, priority, is_active, rule_class, description) VALUES ('rsd', '/^rsd$/i', 'rsd', 'AtomHandler', 'rsd', '1', '1', '0', 'RSD output');
