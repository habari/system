...
class UserHandler extends ActionHandler
{
	...
	*/
	...
	protected function login_form()
	{
		...
		$login_form_title = sprintf('<h1><a href="%s" title="%s"><img src="%s" style="height:52px;width:41px;margin-right:10px;vertical-align:top;">%s</a></h1>', Site::get_url('site'), _t('Go to Site'), Site::get_url('habari', '/system/admin/images/habari.logo.png'), Options::get('title') );
