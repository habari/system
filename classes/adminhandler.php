...
class AdminHandler extends ActionHandler
{
	...
	public function act_admin()
	{
		...
		Stack::add('admin_stylesheet', array(Site::get_url('habari') . "/3rdparty/jqueryui/style.css", 'screen'), 'jqueryui');
		Stack::add('admin_stylesheet', array(Site::get_url('habari') . "/3rdparty/colorpicker/colorpicker.css", 'screen'), 'colorpicker', array('jqueryui'));
		Stack::add('admin_stylesheet', array(Site::get_url('admin_theme') . "/css/formcontrols.css", 'screen'), 'formcontrols', array('colorpicker', 'jqueryui'), 'build_css');
		Stack::add('admin_stylesheet', array(Site::get_url('admin_theme') . '/css/admin.css', 'screen'), 'admin', array('formcontrols', 'jqueryui'), 'build_css');
	...
	public function get_themes()
	{
		...
		$this->theme->active_theme_class= Themes::create();
	...
	*/
	...
	public static function setup_stacks()
	{
		...
		Stack::add( 'admin_header_javascript', Site::get_url('admin_theme') . "/js/formcontrols.js", 'formcontrols', array('jquery', 'jquery.ui', 'colorpicker'), 'build_js');
		Stack::add( 'admin_header_javascript', Site::get_url('admin_theme') . "/js/media.js", 'media', array('jquery', 'jquery.ui', 'colorpicker'), 'build_js' );
		Stack::add( 'admin_header_javascript', Site::get_url('admin_theme') . "/js/admin.js", 'admin', array('jquery', 'jquery.ui', 'colorpicker'), 'build_js' );
