...
class AdminHandler extends ActionHandler
{
	...
	**/
	...
	{
		$this->fetch_logs();
		Stack::add( 'admin_header_javascript', Site::get_url('habari') . '/3rdparty/thickbox/thickbox.js', 'thickbox-js' );
		Stack::add( 'admin_stylesheet', array(Site::get_url('habari') . '/3rdparty/thickbox/thickbox.css', 'screen'), 'thickbox-css' );
		$this->display( 'logs' );
	}
