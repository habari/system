...
class Stack
{
	...
	public static function action_register_stackitems()
	{
		...
		StackItem::register( 'dashboard-js', Site::get_url( 'admin_theme', '/js/dashboard.js' ) )->add_dependency( 'jquery' )->add_dependency( 'locale-js' );
        StackItem::register( 'groups-js', Site::get_url( 'admin_theme', '/js/groups.js' ) )->add_dependency( 'jquery' )->add_dependency( 'locale-js' );
        StackItem::register( 'manage-js', Site::get_url( 'admin_theme', '/js/manage.js' ) )->add_dependency( 'jquery' )->add_dependency( 'locale-js' );
		StackItem::register( 'themes-js', Site::get_url( 'admin_theme', '/js/themes.js' ) )->add_dependency( 'jquery' )->add_dependency( 'locale-js' );
