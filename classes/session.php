...
class Session extends \ArrayObject
{
	...
	public function __construct()
	{
		if(isset($_COOKIE[self::HABARI_SESSION_COOKIE_NAME])) {
			$this->session_id = $_COOKIE[self::HABARI_SESSION_COOKIE_NAME];
			$this->read();
		}

		register_shutdown_function(Method::create($this, 'shutdown'));
	}
	...
	public function write()
	{
		...
		$dowrite = Plugins::filter( 'session_write', $this->changed, $this->session_id, $data );
	...
	public function offsetSet($offset, $value)
	{
		...
		$this->changed = true;
		// if we don't have a session_id already, set one
		if(is_null($this->session_id)) {
			$this->session_id = UUID::get();
			setcookie(self::HABARI_SESSION_COOKIE_NAME, $this->session_id, null, '/');
		}
	}
}
