 ...
 */
	...
	if($db->query("INSERT INTO habari__posts (slug, title, guid, content, author, status, pubdate, updated) VALUES (?, ?, ?, ?, ?, ?, ?, ?);",
	...
	if($db->insert('habari__posts', array (
		'slug'=>'third-post',
		'title'=>'Third Post',
	...
	// Output any errors
	echo "Errors:<pre>" . print_r($db->get_errors(), 1) . "</pre>";
	}
}
?>