...
class RewriteRules extends ArrayObject
{
	...
	public static function add_system_rules( $rules )
	{
		$default_rules = array(
			...
			array( 'name' => 'configure_block', 'parse_regex' => '#^admin/(?P<page>configure_block)/?$#i', 'build_str' => 'admin_ajax/{$page}', 'handler' => 'AdminThemesHandler', 'action' => 'admin', 'priority' => 4, 'description' => 'Configure a block in an ifram' ),
